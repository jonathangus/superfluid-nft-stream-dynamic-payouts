...
export declare namespace IL1CrossDomainMessenger {
  export type L2MessageInclusionProofStruct = {
    stateRoot: BytesLike;
    stateRootBatchHeader: LibOVMCodec.ChainBatchHeaderStruct;
    stateRootProof: LibOVMCodec.ChainInclusionProofStruct;
  ...
  export type L2MessageInclusionProofStructOutput = [
    string,
    LibOVMCodec.ChainBatchHeaderStructOutput,
    LibOVMCodec.ChainInclusionProofStructOutput,
    string,
    string
  ] & {
    stateRoot: string;
    stateRootBatchHeader: LibOVMCodec.ChainBatchHeaderStructOutput;
    stateRootProof: LibOVMCodec.ChainInclusionProofStructOutput;
